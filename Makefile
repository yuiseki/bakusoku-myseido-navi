...
.PHONY: public/words.json
public/words.json: tmp/words.txt
	cat tmp/words.txt | sort | uniq -c | sort -nr | awk '{ print $$2 }' | sed '/[^a-zA-Z0-9]/!d' | head -n300 | jq -nR '[inputs | select(length>1)]' > public/words.json

.PHONY: public/categories/life_stage_categories.json
...
.PHONY: public/categories/personal_service_categories.json
...
.PHONY: public/categories/personal_purpose_categories.json
...
.PHONY: public/categories/support_categories.json
...
.PHONY: public/categories/situation_categories.json
...
.PHONY: public/categories/request_categories.json
...
.PHONY: public/categories/target_categories.json
...
.PHONY: public/categories/purpose_categories.json
